...
export interface AuditOptions {
  /** Promo copy/banner generation — gated to Standard/Pro plans. */
...
async function runAuditInner(
  ...
  const [verdictCopy, promoCopy, bannerDesign, brokenLinks, imageSample, adsTxt, ogImage, pageSpeed] = await Promise.all([
    ...
    includePromo ? generateBannerDesign(primary.host, primary.overall, primary.categories) : Promise.resolve(null),
