...
import { checkBrokenLinks, checkImageSample, checkAdsTxt, checkOgImage, checkServerHardening } from "./network-checks";
...
async function runAuditInner(
  ...
  const [verdictCopy, promoCopy, bannerDesign, brokenLinks, imageSample, adsTxt, ogImage, pageSpeed, emailAuth, serverHardening] = await Promise.all([
