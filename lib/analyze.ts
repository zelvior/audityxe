...
import { checkBrokenLinks, checkImageSample, checkAdsTxt, checkOgImage, checkServerHardening, checkSourceMapExposure } from "./network-checks";
...
async function runAuditInner(
  ...
  const [verdictCopy, promoCopy, bannerDesign, brokenLinks, imageSample, adsTxt, ogImage, pageSpeed, emailAuth, serverHardening, dnsSecurity, sourceMapExposure] = await Promise.all([
