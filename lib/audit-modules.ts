...
export function buildAuditModules(ctx: ModuleContext): AuditModule[] {
  ...
  modules.push(makeModule("dns-security", "DNS Security (CAA, DNSSEC & Subdomain Takeover)", "Live DNS checks for certificate-issuance restrictions, DNSSEC signing, and dangling CNAME takeover risk.", dnsFindings));
