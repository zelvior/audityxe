...
directory listing), **DNS Security** (CAA records, dangling
CNAME/subdomain takeover detection), **Subresource Integrity & Source
Maps** (cross-origin asset integrity, exposed .js.map files),
...
any single occurrence), Technical Stack, HTML Structure, Meta Tags,
Sitemap & Robots.txt, Structured Data, Broken Links, Image
