...
import { ArrowRight, Plus, X, Lock } from "lucide-react";
...
export default function Hero({ onAnalyze, disabled, isAuthed, hasAccount, authLoading, canCompare, prefillUrl }: HeroProps) {
  ...
  return (
    <section className="relative pt-20 sm:pt-28 pb-12 sm:pb-16 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <h1 className="font-display font-medium text-[32px] leading-[1.1] sm:text-[48px] sm:leading-[1.05] md:text-[56px] md:leading-[1.03] tracking-tight text-gradient px-1">
        ...
        >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-5 py-3 rounded-card bg-secondary font-semibold text-sm disabled:opacity-40 disabled:cursor-not-allowed hover:brightness-110 transition shrink-0"
          >
