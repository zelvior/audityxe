  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <button
        ...
        onClick={onGoogle}
        disabled={disabled}
        className="flex items-center justify-center gap-2 py-2.5 rounded-card glass text-sm font-medium hover:border-[rgb(var(--color-text-primary)/0.2)] transition disabled:opacity-50"
      >
        <GoogleIcon />
        Google
      </button>
