  ...
  return (
    <div>
      ...
      <div className="px-4 sm:px-6 py-10 sm:py-14">
        <div className="max-w-2xl mx-auto text-center glass rounded-card p-8 sm:p-10">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-card bg-secondary font-semibold text-sm hover:brightness-110 transition"
          >
            Audit my site free
            <ArrowRight size={16} />
          </Link>
