...
/**
 * Isometric "processing" loader — the Uiverse.io "Juanes200122" SVG
 * loader, recolored from its original purple/blue gradient family to
 * Audityxe's rust/gold accent palette (kept as fixed hex per gradient
 * stop, same as the source; SVG gradients can't reference CSS custom
 * properties the way plain fills can, so this one intentionally
 * doesn't auto-flip for dark mode the way the rest of the site does —
 * the warm rust/gold reads fine on both light and dark backgrounds).
 * All ids are namespaced with an `ax-` prefix so this can be mounted
 * more than once on a page without SVG id collisions between
 * instances (gradients/masks are referenced by id and are otherwise
 * global to the document).
 */
export default function IsometricLoader({ size = 136, className = "" }: { size?: number; className?: string }) {
  return (
    <div className={`ax-loader-wrap ${className}`} style={{ width: (size * 94) / 136, height: size }}>
      <svg
        id="ax-loader-svg"
      ...
      >
        ...
        <defs>
          <linearGradient
            ...
            id="ax-paint0"
          >
            <stop stopColor="#8C3703"></stop>
            <stop stopColor="#B5460A" offset="1"></stop>
          </linearGradient>
          <linearGradient
            gradientUnits="userSpaceOnUse"
            y2="91.1638"
            ...
            id="ax-paint1"
          >
            <stop stopColor="#D99A3E"></stop>
            <stop stopColor="#4A1D02" offset="0.29"></stop>
            <stop stopColor="#8C3703" offset="1"></stop>
          </linearGradient>
          <linearGradient
            gradientUnits="userSpaceOnUse"
            y2="85.0762"
          ...
          >
            <stop stopColor="#8C3703"></stop>
            <stop stopColor="#F0C46B" offset="1"></stop>
          </linearGradient>
          <linearGradient
            gradientUnits="userSpaceOnUse"
            y2="48.3519"
      ...
      <style jsx>{`
        ...
        .ax-loader-wrap :global(svg) {
          width: 100%;
          height: 100%;
          overflow: visible;
        }

        @keyframes ax-fade-particles {
          0%,
          100% {
            opacity: 1;
          }
        ...
        .ax-loader-wrap :global(#ax-particles) {
          animation: ax-fade-particles 5s infinite alternate;
        }
        .ax-loader-wrap :global(.particle) {
          animation: ax-float-up linear infinite;
        }
        .ax-loader-wrap :global(.p1) {
          animation-duration: 2.2s;
          animation-delay: 0s;
        }
        .ax-loader-wrap :global(.p2) {
          animation-duration: 2.5s;
          animation-delay: 0.3s;
        }
        .ax-loader-wrap :global(.p3) {
          animation-duration: 2s;
          animation-delay: 0.6s;
        }
        .ax-loader-wrap :global(.p4) {
          animation-duration: 2.8s;
          animation-delay: 0.2s;
        }
        .ax-loader-wrap :global(.p5) {
          animation-duration: 2.3s;
          animation-delay: 0.4s;
        }
        .ax-loader-wrap :global(.p6) {
          animation-duration: 3s;
          animation-delay: 0.1s;
        }
        .ax-loader-wrap :global(.p7) {
          animation-duration: 2.1s;
          animation-delay: 0.5s;
        }
        .ax-loader-wrap :global(.p8) {
          animation-duration: 2.6s;
          animation-delay: 0.2s;
        }
        .ax-loader-wrap :global(.p9) {
          animation-duration: 2.4s;
          animation-delay: 0.3s;
        }

        @keyframes ax-bounce-lines {
          0%,
          100% {
            transform: translateY(0);
          }
        ...
        .ax-loader-wrap :global(#ax-line-v1),
        .ax-loader-wrap :global(#ax-line-v2),
        .ax-loader-wrap :global(#ax-node-server),
        .ax-loader-wrap :global(#ax-panel-right),
        .ax-loader-wrap :global(#ax-reflectores),
        .ax-loader-wrap :global(#ax-particles) {
          animation: ax-bounce-lines 3s ease-in-out infinite alternate;
        }
        .ax-loader-wrap :global(#ax-line-v2) {
          animation-delay: 0.2s;
        }
