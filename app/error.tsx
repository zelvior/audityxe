    ...
    <main className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 py-16 sm:py-24">
        <div className="max-w-md mx-auto text-center">
          <div className="w-16 h-16 rounded-card glass flex items-center justify-center mx-auto mb-6 border border-rose/30">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-card glass font-semibold text-sm hover:text-primary transition"
            >
              <Home size={16} />
              Go home
            </Link>
