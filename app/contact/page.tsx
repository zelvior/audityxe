    ...
    <main className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 px-4 sm:px-6 py-8 sm:py-12">
        <div className="max-w-lg mx-auto">
          ...
          <div className="glass rounded-2xl p-5 sm:p-6 mb-6 flex items-center gap-3">
          ...
          <form onSubmit={handleSubmit} className="glass rounded-2xl p-5 sm:p-6 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="w-full bg-surface2 border border-border rounded-xl px-3.5 py-2.5 text-sm outline-none resize-none focus-visible:border-primary"
              />
            </div>
            <button
              type="submit"
