        ...
        <div className="max-w-md w-full">
          ...
          {justVerified ? (
            ...
            <div className="glass rounded-2xl p-6 sm:p-8">
              <div className="w-12 h-12 rounded-2xl bg-amber/15 flex items-center justify-center mb-5">
              ...
              <div className="bg-surface2/60 rounded-xl p-4 mb-5 flex items-start gap-2.5">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <button
                  onClick={handleCheck}
                  disabled={checking}
                  className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-gradient-to-r from-primary to-accent font-semibold text-sm hover:brightness-110 transition disabled:opacity-50"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl glass text-sm font-medium hover:border-white/20 transition disabled:opacity-50"
                >
                  <Send size={14} />
