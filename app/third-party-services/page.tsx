...
export const metadata: Metadata = {
  ...canonicalMeta("third-party-services"),
...
export default function ThirdPartyServicesPage() {
  return (
    <LegalLayout title="Third-Party Services" updated="September 2026" path="third-party-services">
      ...
      <ul>
        ...
        <li><strong>TokenRouter (or your own configured provider)</strong> — AI model access for promo copy generation. This is a Pro-only, bring-your-own-key feature: Audityxe's own servers make this call using your saved key, but never see the promo output beyond relaying it back to you.</li>
