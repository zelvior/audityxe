      ...
      <div className="flex-1 px-4 sm:px-6 py-8 sm:py-12">
        <div className="max-w-lg mx-auto">
          ...
          <SectionCard icon={<UserIcon size={15} className="text-primary" />} title="Profile">
            <form onSubmit={handleSaveName} className="space-y-3">
              ...
              <button
                type="submit"
                disabled={nameSaving}
                className="flex items-center gap-1.5 text-xs font-semibold px-4 py-2 rounded-lg bg-gradient-to-r from-primary to-accent hover:brightness-110 transition disabled:opacity-50"
              >
                ...
                <div className="space-y-3">
                  ...
                  {hasPasswordProvider && (
                    <input
                      ...
                      className="w-full bg-surface2 border border-border rounded-xl px-3.5 py-2.5 text-sm outline-none focus-visible:border-rose"
                    />
                  )}
          ...
          <button
            ...
            className="w-full text-center py-3 rounded-xl glass text-sm font-medium text-text-secondary hover:text-primary transition"
          >
            Sign out
          </button>
        </div>
