        ...
        <div className="max-w-lg mx-auto">
            ...
            {hasPasswordProvider ? (
              <form onSubmit={handleChangePassword} className="space-y-3">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs font-semibold px-4 py-2 rounded-lg glass hover:border-[rgb(var(--color-text-primary)/0.2)] transition disabled:opacity-50"
                >
                  {passwordSaving ? (
          ...
          >
            <button
              ...
              disabled={exporting}
              className="flex items-center gap-1.5 text-xs font-semibold px-4 py-2 rounded-lg glass hover:border-[rgb(var(--color-text-primary)/0.2)] transition disabled:opacity-50 mb-3"
            >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="text-xs font-medium px-4 py-2 rounded-lg glass hover:border-[rgb(var(--color-text-primary)/0.2)] transition"
                    >
                      Cancel
                    </button>
                  </div>
