...
function LoginForm() {
  const { signInWithEmail, signInWithGoogle, signInWithGithub, user, authError } = useAuth();
  ...
  return (
    <div className="max-w-sm mx-auto w-full glass rounded-card p-6 sm:p-8">
      <Link
        href="/"
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <label htmlFor="password" className="block text-xs font-mono text-text-secondary">
              Password
            </label>
