...
export default function AboutPage() {
  return (
    <LegalLayout title="About Audityxe" updated="August 2026" path="about">
      ...
      <ul>
        <li>
          <strong>Indie makers &amp; solo founders</strong> — a fast, specific first pass on a
          landing page before launch, no agency retainer needed.
        </li>
        <li>
        ...
        <li>
          ...
          a manual checklist, with bulk audit on Pro.
        </li>
      </ul>
    </LegalLayout>
  );
